...
function SignupAuth() {
  ...
  return (
    <section className="w-screen h-screen flex bg-landing-bg-image bg-no-repeat bg-center bg-cover">
      <div className="w-1/2 rounded-2xl m-auto flex flex-col items-center text-white backdrop-blur-lg backdrop-saturate-[200%] bg-[rgba(17, 25, 40, 0.6)] border border-[rgba(255, 255, 255, 0.125)] mob:w-11/12 gap-5 py-5">
        <div className="email-div w-full border-b flex justify-center items-center flex-col p-3 gap-3">
          <TextFieldComponent
            label="email / number"
            name="user_info"
            width={"50%"}
          ...
          <PortfolioButton
            text="VERIFY EMAIL"
            className={`border pl-28 border-solid w-1/2 h-12 rounded-full flex items-center justify-between mob:w-11/12 mob:pl-8 mob:mt-4`}
            type={"button"}
